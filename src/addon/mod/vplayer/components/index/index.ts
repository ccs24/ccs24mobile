 ...
 */
@Component({
    selector: 'addon-mod-vplayer-index',
    templateUrl: 'addon-mod-vplayer-index.html',
})
export class AddonModVPlayerIndexComponent extends CoreCourseModuleMainResourceComponent {
    ...
    protected fetchContentDefaultError = 'addon.mod_vplayer.errorwhileloadingthepage';

    constructor(injector: Injector, private pageProvider: AddonModVPlayerProvider, private courseProvider: CoreCourseProvider,
            private appProvider: CoreAppProvider, private pageHelper: AddonModVPlayerHelperProvider,
            private pagePrefetch: AddonModVPlayerPrefetchHandler, private utils: CoreUtilsProvider) {
        super(injector);
    }
