 ...
 */
@Injectable()
export class AddonModVPlayerProvider {
    static COMPONENT = 'mmaModVPlayer';

    protected ROOT_CACHE_KEY = 'mmaModVPlayer:';
    protected logger;

    constructor(logger: CoreLoggerProvider, private sitesProvider: CoreSitesProvider, private courseProvider: CoreCourseProvider,
            private utils: CoreUtilsProvider, private filepoolProvider: CoreFilepoolProvider,
            private logHelper: CoreCourseLogHelperProvider) {
        this.logger = logger.getInstance('AddonModVPlayerProvider');
    }
    ...
    protected getPageByKey(courseId: number, key: string, value: any, siteId?: string): Promise<any> {
        return this.sitesProvider.getSite(siteId).then((site) => {
            ...
            return site.read('mod_vplayer_get_player_by_courses', params, preSets).then((response) => {
    ...
    protected getPageCacheKey(courseId: number): string {
        return this.ROOT_CACHE_KEY + 'vplayer:' + courseId;
    }
    ...
    invalidateContent(moduleId: number, courseId: number, siteId?: string): Promise<any> {
        ...
        promises.push(this.filepoolProvider.invalidateFilesByComponent(siteId, AddonModVPlayerProvider.COMPONENT, moduleId));
    ...
    isGetPageWSAvailable(): boolean {
        return this.sitesProvider.wsAvailableInCurrentSite('mod_vplayer_get_player_by_courses');
    }
    ...
    logView(id: number, siteId?: string): Promise<any> {
        ...
        return this.logHelper.log('mod_vplayer_view_player', params, AddonModVPlayerProvider.COMPONENT, id, siteId);
    }
}
