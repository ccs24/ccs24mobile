 ...
 */
@Injectable()
export class AddonModVPlayerPluginFileHandler implements CorePluginFileHandler {
    name = 'AddonModVPlayerPluginFileHandler';
    component = 'mod_vplayer';
    ...
    getComponentRevisionRegExp(args: string[]): RegExp {
        ...
        if (args[2] == 'content') {
            ...
            return new RegExp('/mod_vplayer/content/([0-9]+)/');
        }
    }
